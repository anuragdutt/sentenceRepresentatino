...
class ProbingClassifier(models.Model):
    def __init__(self,
        ...
        self.l = layers.Dense(self._classes_num)
        # TODO(students): end
    ...
    def call(self, inputs: tf.Tensor, training: bool =False) -> tf.Tensor:
        ...
        # TODO(students): start
        # ...
        mod = self._pretrained_model
        mod_run = mod(inputs = inputs)
        lr = tf.transpose(mod_run['layer_representations'], [1,0,2])
        lnum = lr[self._layer_num-1]
        logits = self.l(lnum)
